...
class FilterBoxSingle extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      ...
      return (
        <div key={filter} className="m-b-5">
          ...
          <Select
            ...
            key={filter}
            clearable={false}
            value={this.state.selectedValues[filter][0]}
            options={data.map((opt) => {
              ...
              return { value: opt.id, label: opt.id, style, clearableValue: false };
            })}
...
FilterBoxSingle.propTypes = propTypes;
FilterBoxSingle.defaultProps = defaultProps;

function filterBoxSingle(slice) {
    ...
    $.getJSON(url, (payload) => {
      ...
      ReactDOM.render(
        <FilterBoxSingle
          ...
          origSelectedValues={sliceFilters || {}}
        />,
...
module.exports = filterBoxSingle;
